...
namespace Omise.Models {
    ...
    public partial class Charge : ModelBase {
        ...
        public List<string> Missing3dsFields { get; set; }
        [JsonProperty("authenticated_by")]
        [JsonConverter(typeof(StringEnumConverter))]
        public AuthFlow? AuthenticatedBy { get; set; }
        ...
        public override bool Equals(object obj) {
            ...
            return base.Equals(obj) &&
                ...
                object.Equals(this.MerchantAdviceCode, another.MerchantAdviceCode) &&
                object.Equals(this.Missing3dsFields, another.Missing3dsFields) &&
                object.Equals(this.AuthenticatedBy, another.AuthenticatedBy) &&
                true;
        }
        ...
        public override int GetHashCode() {
            unchecked {
                ...
                if (MerchantAdviceCode != default(string)) {
                    hash = hash * 23 + MerchantAdviceCode.GetHashCode();
                }
                if (Missing3dsFields != default(List<string>)) {
                    hash = hash * 23 + Missing3dsFields.GetHashCode();
                }
                if (AuthenticatedBy != default(AuthFlow?)) {
                    hash = hash * 23 + AuthenticatedBy.GetHashCode();
                }
